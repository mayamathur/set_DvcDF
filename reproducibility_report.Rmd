...
knitr::kable(accuracy_tibble, digits = 2)
```
...
Monolingual standard deviations:
```{r}
...
The following compares the monolinguals' mean reported in the text of the paper to the monolinguals' mean I calculated:
```{r}
compareValues(reportedValue = 4.31, obtainedValue = 4.64)
```

The following compares the bilinguals' mean reported in the text of the paper to the bilinguals' mean I calculated:
```{r}
compareValues(reportedValue = 4.64, obtainedValue = 4.34)
```

I will compare my calculated values to the values reported in Table 3 later in this report.
