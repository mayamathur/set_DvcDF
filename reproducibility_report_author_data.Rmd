...
Intercept: SE
```{r}
compareValues(reportedValue = 283, obtainedValue = 287.58)
```

Intercept: t-value
```{r}
compareValues(reportedValue = 11.57, obtainedValue = 11.382)
```
...
Group: coefficient
```{r}
compareValues(reportedValue = -283, obtainedValue = -283.11)
```

Group: SE
```{r}
compareValues(reportedValue = 400, obtainedValue = 406.7)
```

Group: t-value
```{r}
compareValues(reportedValue = -.71, obtainedValue = -0.7)
```
